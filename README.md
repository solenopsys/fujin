...
Задача Fujin — разделить бизнес-логику и тяжелую обработку данных. Fujin берет на себя все что касается ветвления и бизнеслогики все тяжелвые вычислений и хранения данных обеспечиваются модулями на zig.

## Что такое Fujin

Это **строгий, компактный, чистый** язык Fujin
Работает внутри
